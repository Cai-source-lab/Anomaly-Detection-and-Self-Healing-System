...
<div class="rightinfo">
    <div class="tools">
        ...
        <form action="cy_Spls?role=<%= selectedCustomer %>" method="post" style="margin-top:10px;">
            ...
            <b><label style="margin-left:30px;font-size:16px;">总金额：<%= sumMoney %>￥</label></b>
            <ul class="toolbar1">
                <li><a href="#" onclick="qk('<%= selectedCustomer %>'); return false;"><span><img src="images/t03.png" /></span>清空列表</a></li>
                <li><a href="#" onclick="reg('<%= selectedCustomer %>'); return false;"><span><img src="images/t01.png" /></span>商品结算</a></li>
            </ul>
        </form>
    </div>
